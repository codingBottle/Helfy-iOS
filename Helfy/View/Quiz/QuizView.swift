...
//            buttonStackView.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 30),
//            buttonStackView.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -30),
            ...
            buttonStackView.heightAnchor.constraint(equalToConstant: 230),
            buttonStackView.widthAnchor.constraint(equalToConstant: 330)
        ])
    ...
    func updateImageLayout() {
        if quizImage.image == nil {
            ...
            quizTextTopConstraint = quizText.topAnchor.constraint(equalTo: quizNumber.bottomAnchor, constant: 100)
